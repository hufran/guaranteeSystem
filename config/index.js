...
module.exports = {
  dev: {
    ...
    host: 'localhost', // can be overwritten by process.env.HOST10.4.34.45
  ...
  prod: {
    ...
    port: 4003, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
  }
}
